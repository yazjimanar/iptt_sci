...
export default function IndicatorForm(props) {
  ...
  useEffect(() => {
    ...
    const outputs = indicatorService.getAllIndicators("OutputsData");
    setOutcomeOptions(outputs);
      ...
      <Grid container>
        <Grid item xs={6}>
          <Controls.Select
            ...
            options={outcomeOptions.map((output) => ({
              id: output.indicatorId,
              title: output.indicatorId,
            }))}
